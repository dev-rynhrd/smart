...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'SMART' => [
            'driver' => 'sqlsrv',
            'host' => env('DB_SMART_HOST', 'localhost'),
            'port' => env('DB_SMART_PORT', '1433'),
            'database' => env('DB_SMART_DATABASE', 'SMART'),
            'username' => env('DB_SMART_USERNAME', 'sa'),
            'password' => env('DB_SMART_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
